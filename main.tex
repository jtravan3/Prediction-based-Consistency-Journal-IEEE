...
% The prediction-based solution consists of three actions: grant action (See Definition \ref{grant_action}), decline action (See Definition \ref{decline_action}), and the elevate action (See Definition \ref{elevate_action}). We will analyze all three actions in regards to 2PL to show a complete analysis.
